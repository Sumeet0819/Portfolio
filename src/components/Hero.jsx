...
export default function Hero() {
  ...
  return (
    <div className="w-full min-h-[80vh] px-4 sm:px-6 lg:px-10 py-10 sm:py-16 lg:py-20 flex flex-col lg:flex-row justify-between gap-8 lg:gap-12">
  ...
  return (
    <motion.div
      ...
      className="w-full sm:w-1/2 lg:w-1/2 h-[150px] sm:h-[180px] lg:h-[200px] bg-gray-300 rounded-xs shadow-md cursor-pointer touch-manipulation"
    />
  );
})}
